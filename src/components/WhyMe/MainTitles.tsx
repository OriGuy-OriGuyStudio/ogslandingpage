function MainTitles() {
  return (
    <div className="col-span-full z-10">
      <h3 className="text-balance text-textsizebrandh2 font-black leading-none md:text-textsizebrandh1">
      ...
      <h4 className="mb-8 mt-2 w-[100%] text-textsizebrandh6 lg:mb-16 lg:mt-4 lg:w-[50%]">
