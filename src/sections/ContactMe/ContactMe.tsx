...
function ContactMe() {
  return (
    <div className="bottom-0 bg-colorBrandPurple900dark text-colorBrandWhiteYellow100light px-4 py-20 sm:px-20">
      <div className="text-textsizebrandh2 mb-4 font-black leading-none md:text-textsizebrandh1">
        ...
        <p className="mt-2 text-textsizebrandh3 text-colorBrandPink500dark">
          בחרו מה שנוח לכם, ואני אדאג לשאר
        </p>
      </div>
      <div className="mt-6 flex flex-col gap-8 lg:flex-row">
        <div className="leading-none">
          <h4 className="text-textsizebrandh5 font-black">שונאים טפסים?</h4>
          <h5 className="text-textsizebrandh5 font-black">שלחו לי הודעה</h5>
          <div className="mt-4 space-y-4">
            <div className="flex flex-row items-center gap-4">
              ...
              />
              <a
                className="text-textsizebrandh6 font-normal"
        ...
        <div className="leading-none lg:w-5/12">
          <h4 className="text-textsizebrandh5 font-black">אוהבים טפסים?</h4>
          <h5 className="text-textsizebrandh5 font-black">שלחו לי הודעה</h5>
          <div className="mt-4 space-y-4">
            <ContactMeForm />
          </div>
